                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                    'images/bike.png', height: 70, width: 80.0,),
                                  SizedBox(width: 16.0),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            displayToastMessage('Searching ubergo', context);
                            setState(() {
                              state = 'requesting';
                              carRideType='uber-go';
                            });
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                    'images/ubergo.png', height: 70, width: 80.0,),
                                  SizedBox(width: 16.0),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Uber-Go', style: TextStyle(
                                          fontFamily: 'bolt-regular',
                                          fontSize: 18.0),),
                                      Text((tripDirectionDetails != null)
                                          ? tripDirectionDetails.distanceText
                        ...
                        GestureDetector(
                          onTap: (){
                            displayToastMessage('Searching uberx', context);
                            setState(() {
                              state = 'requesting';
                              carRideType='uber-x';
                            });
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                    'images/uberx.png', height: 70, width: 80.0,),
                                  SizedBox(width: 16.0),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Uber-X', style: TextStyle(
                                          fontFamily: 'bolt-regular',
                                          fontSize: 18.0),),
                                      Text((tripDirectionDetails != null)
                                          ? tripDirectionDetails.distanceText
  ...
  void initGeoFireListener()
{
  ...
  void searchNearestDrivers()
  {
    ...
    driverRef.child(driver.key).child('car_details').child('tybe').once().
